const appName = 'Panel'
const appCacheName = 'Panel-1.8.5';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.8.5/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
