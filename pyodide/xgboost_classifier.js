...
async function startApplication() {
  ...
  try {
    await self.pyodide.runPythonAsync(`
      import micropip
      await micropip.install(['https://cdn.holoviz.org/panel/wheels/bokeh-3.8.1-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.8.5/dist/wheels/panel-1.8.5-py3-none-any.whl', 'pyodide-http', 'pandas', 'scikit-learn', 'xgboost']);
    `);
  } catch(e) {
    console.log(e)
    self.postMessage({
